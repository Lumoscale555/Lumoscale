...
const ServicesOverview = () => {
  ...
  className="relative group opacity-0 transition-all duration-500 flex flex-col h-full"
  style={{ transitionDelay: `${service.delay}ms` }}
>
  <div className="overflow-hidden rounded-xl bg-gradient-to-br from-dark-800/80 to-dark-900/95 backdrop-blur-md border border-dark-700/30 shadow-lg hover:shadow-primary/20 hover:border-primary/30 transition-all duration-300 flex flex-col h-full">
