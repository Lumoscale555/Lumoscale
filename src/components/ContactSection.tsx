    ...
    try {
      ...
      if (dbError) {
        toast({
          ...
          description: "Could not save your message. Try again.",
          variant: "destructive",
        });
        setSubmitting(false);
        return;
      ...
      const res = await fetch(
        "https://difgbugfvmkjfhegzqdm.supabase.co/functions/v1/send-contact-email",
        {
          method: "POST",
          headers: {
      ...
      if (!res.ok) {
        toast({
          title: "Email failed",
          description: "Your message was saved, but email could not be sent.",
          variant: "destructive",
        });
        setSubmitting(false);
        return;
      ...
      toast({
        ...
        description: "We received your details and will get back to you soon.",
        variant: "default",
      });
    } catch (err) {
      toast({
